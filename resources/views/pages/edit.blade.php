            ...
            <div class="card uper">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('news.update',$news->id) }}" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        <input type="checkbox" id="lang " name="mycheckbox" value="rus"> Russian Version<br>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" name="detail">{{$news->content}}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <p> <img src="{{ asset('upload/'.$news->image)}}" width="300" height="300" ></p>
                        </div>
